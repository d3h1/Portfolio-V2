...
const Main = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      setAngle((prevAngle) => (prevAngle + 0.01 + (Math.random() - 0.5) * 0.02) % (2 * Math.PI));
    ...
    >
      ...
      <div className="page-container">
        <div className="flex flex-col items-center">
          ...
          <h3 className="p-2 xsm:text-base sm:text-xl text-gray-light border border-black border-y-violet-600/40 w-[70%] m-auto cursor-default">
            I leverage cutting-edge technologies to develop exceptional
            full-stack applications, combining experience and knowledge for
            stable development. My approach fosters relentless innovation,
            pushing boundaries for clients.
          </h3>
      ...
      <div className="xsm:hidden sm:flex absolute xs:bottom-10 bottom-8 w-full justify-center items-center">
        {/* We will link our framer motion animation to the about page so we can go to that on the scroll button */}
          <div className=" w-[35px] h-[64px] rounded-3xl border-4 border-violet-600/30 flex justify-center items-start p-2">
            ...
            <motion.div
              ...
              className="w-3 h-3 rounded-full bg-violet-600/40 mb-1"
            />
          </div>
      </div>
    </div>
